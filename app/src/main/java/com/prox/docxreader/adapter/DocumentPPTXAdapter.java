...
public class DocumentPPTXAdapter extends RecyclerView.Adapter<DocumentPPTXAdapter.DocumentViewHolder> {
    ...
    public DocumentPPTXAdapter(OnClickItemDocumentListener onClickItemDocumentListener,
    ...
    public void onBindViewHolder(@NonNull DocumentViewHolder holder, int position) {
        ...
        holder.binding.itemDocx.img.setImageResource(R.drawable.ic_item_pptx);
