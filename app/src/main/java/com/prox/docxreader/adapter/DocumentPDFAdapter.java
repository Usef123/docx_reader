...
public class DocumentPDFAdapter extends RecyclerView.Adapter<DocumentPDFAdapter.DocumentViewHolder> {
    ...
    public DocumentPDFAdapter(OnClickItemDocumentListener onClickItemDocumentListener,
    ...
    public void onBindViewHolder(@NonNull DocumentViewHolder holder, int position) {
        ...
        holder.binding.itemDocx.img.setImageResource(R.drawable.ic_item_pdf);
